...
function showUploadingImg() {
  ...
  var uploadButtonImg = document.getElementById('uploadImg');
  var uploadingButtonImg = document.getElementById('uploadingImg');

  // Hide the submit button and show the loading button
  uploadButtonImg.style.display = 'none';
  uploadingButtonImg.style.display = 'block';
}
